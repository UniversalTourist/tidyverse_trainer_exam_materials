...
Let's try to read the code below: I have the dataframe called coffee_ratings, I call it. And then I group that dataframe by `species` variable and then I summarise into two statistics. One is mean of a variable and the other is some proportion. 

What I see in here is that everything is chained. I can read that code from left to right like a sentence. Pipe helps us to connect those verbs.
