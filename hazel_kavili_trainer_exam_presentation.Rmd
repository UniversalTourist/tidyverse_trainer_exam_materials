...
```{r eval=TRUE, echo=FALSE}
dt <- select(coffee_ratings, 1:4, 21:34)  
knitr::kable(head(dt))
```
...
We want to look at the mean value of `aroma, flavor and aftertaste` variables by `country_of_origin` for the `species of Arabica`. Can we find the true order of that code piece?
